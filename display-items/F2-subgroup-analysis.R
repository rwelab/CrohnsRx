...
############################## 
# 2 - Subgroup Populations
##############################

subgroups <- subgroup.cohorts(drug_ordering)
subgroups
...
#----------------------------- 
# Row 3 - Continuous Covariates (Violin)
#-----------------------------
...
# save 
ggsave(filename = 'display-items/F2-subgroup-analysis.pdf', 
       plot = subgroup.final, 
